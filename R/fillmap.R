...
fillmaps<-function(map, figtitle, y , n.col, bk="e", cuts,legendtxt="",
	...
	lay.hei=rep.int(1, nrow(lay.m)),leg.horiz=F){
...
plot(map,col=y1.shad,axes=F, lty=1)
...
fillmap<-function(map, figtitle, y , n.col, bk="e", cuts,legendtxt="",
	leg.loc="bottomright",leg.cex=1.5,main.cex=1.5,main.line=-2,leg.horiz=F){
...
plot(map,col=y.shad,axes=F, lty=1)
title(main=figtitle,cex.main=main.cex,line=main.line) 
